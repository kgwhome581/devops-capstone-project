...
![Build Status](https://github.com/kgwhome581/devops-capstone-project/actions/workflows/workflow.yml/badge.svg)
...
## Project Overview
The goal of this project is to apply DevOps methodologies to a microservice. Key tasks include:
* Implementing RESTful APIs (CRUD operations).
* Achieving **95%** test coverage using Test Driven Development (TDD).
* Automating workflows with **CI/CD pipelines**.
* Containerizing the application with **Docker** and deploying to **Kubernetes/OpenShift**.

## Development Environment

These labs are designed to be executed in the IBM Developer Skills Network Cloud IDE. To initialize your environment:
